...
public class CPSMenu {
    ...
    public String printIntroMessage() {
        ...
        String message = "To Login or create an account as an AttendeeController, Enter '1';" + "\nTo Login or create an account " +
                "as an OrganizerController, Enter '2';" + "\nTo Login or create an account as a SpeakerController, Enter '3';" +
