...
public class AttMessageMenu extends MessageMenu {
    ...
    public String printContactUsernamesPrompt(){
        return "<html>Who do you want to have a group chat with? Enter their usernames in a comma-separated list." +
                "<br>(E.g. 'user1,user2,user3' without apostrophes (''). Please do <b>not</> add spaces after commas)<html/>";
    }
