public class SpeakerManager extends PersonManager {
    ...
    public void addToEventsList(Speaker person,Event event) {
        if(doubleBooking(person, event) == false) {
            person.getEventsSignedUp().add(person.getId());
        }
    }

    public void cancelEvent(Speaker person, Event event) {
     ...
     * @param contact
     */
    public void addToContactsList(Speaker person, Person contact ) {
     ...
     * @return
     */
    public boolean doubleBooking(Speaker person, Event event) {
     ...
     * @return
     */
    public boolean doubleContact(Speaker person, Person contact) {
